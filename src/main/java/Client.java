...
public class Client {
    ...
    static void displayMenu() {
        ...
        while (choice != 0) {
            ...
            System.out.println("5. Set server configuration");
            System.out.println("6. Start the server");
            System.out.println("7. Stop the server");
            System.out.println("8. Restart the server");
            System.out.println("9. Change Access Control policy (only ADMIN)");
            ...
            switch (choice) {
                ...
                case 9:
                    try {
                        System.out.println(server.switchACMode(token));
                        break;
                    }
                    catch (RemoteException e) { e.printStackTrace(); }
                    break;
